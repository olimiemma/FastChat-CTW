...
SERVER_ERROR_MSG = (
    "**NETWORK ERROR DUE TO MANY PEOPLE SEEKING HELP. PLEASE BE PATIENT.**"
)
TEXT_MODERATION_MSG = (
    "$MODERATION$ YOUR TEXT VIOLATES OUR SACRED TEXTS CONTENT MODERATION GUIDELINES."
)
IMAGE_MODERATION_MSG = (
    "$MODERATION$ YOUR IMAGE VIOLATES OUR CONTENT MODERATION GUIDELINES."
)
MODERATION_MSG = "$MODERATION$ YOUR INPUT VIOLATES OUR SACRED TEXTS  MODERATION GUIDELINES."
CONVERSATION_LIMIT_MSG = "I THINK YOU ARE READY!. PLEASE GO FORTH AND EXPERIENCE LIFE, CLEAR HISTORY IF YOU'D LIKE. AND PLEASE PUT YOUR PHONE DOWN AND LOOK UP. THINGS WILL BE FINE..OR YOU COULD JUST START A NEW CONVERSATION, theres that too :shoulder shug emoji:."
INACTIVE_MSG = "THIS SESSION HAS BEEN INACTIVE FOR TOO LONG. SEEMS YOU FINALLY CLEARING YOUR MIND."
